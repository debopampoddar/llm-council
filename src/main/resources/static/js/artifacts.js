...
function renderValidation(validation) {
  ...
  return el("div.stack", {}, [
    ...
    el("p.caption", { text: `Model validator: ${validation.validatorId}. This is a model assessment, not external fact-checking or human review. Its independence from all council answer producers is shown on the trust strip above.` }),
  ]);
}
